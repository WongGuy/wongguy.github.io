...
//      boltStrengthGrades, boltStrengthGradeProperties, boltStrengthThreads,
//      boltStrengthNotes. Don't hand-edit these. They're produced by
//      scripts/generate_bolt_strength_data.py from ISO 898-1 Tables 3-7 in
...
//
// GRADE PROPERTIES: each grade carries a `properties` map of the nominal
// mechanical properties from ISO 898-1 Table 3 — tensile strength (Rm),
// stress under proof load (Sp) and stress at 0,2 % non-proportional
// elongation (Rp0,2), all in MPa. boltStrengthGradeProperties describes
// them (label, symbol, unit, Table 3 footnote). A property the standard
// doesn't give for a class (Rp0,2 below 8.8) is absent from the map; for
// class 8.8, Sp differs by diameter so its value is
// { "d ≤ 16 mm": …, "d > 16 mm": … } rather than a single number.
...
const boltStrengthGrades = [
  ...
  { key: "8.8", label: "8.8", designation: "8.8", shownByDefault: true, properties: { tensileStrength: 800, stressUnderProofLoad: { "d ≤ 16 mm": 580, "d > 16 mm": 600 }, nonProportionalElongationStress: 640 } },
  { key: "9.8", label: "9.8", designation: "9.8", shownByDefault: false, properties: { tensileStrength: 900, stressUnderProofLoad: 650, nonProportionalElongationStress: 720 } },
  { key: "10.9", label: "10.9", designation: "10.9", shownByDefault: true, properties: { tensileStrength: 1000, stressUnderProofLoad: 830, nonProportionalElongationStress: 900 } },
  { key: "12.9", label: "12.9", designation: "12.9/12.9", shownByDefault: true, properties: { tensileStrength: 1200, stressUnderProofLoad: 970, nonProportionalElongationStress: 1080 } },
];

const boltStrengthGradeProperties = [
  ...
  { key: "nonProportionalElongationStress", label: "Stress at 0,2 % non-proportional elongation", symbol: "Rp0,2", unit: "MPa", basis: "nom.", note: "Nominal values are given only for the purpose of the property-class designation system (see Clause 5)." },
];

const boltStrengthThreads = [
  {
    designation: "M3x0.5", size: "M3", diameter: 3, pitch: 0.5, series: "coarse", stressArea: 5.03, d0: 2.531,
    loads: {
  ...
  {
    designation: "M3.5x0.6", size: "M3.5", diameter: 3.5, pitch: 0.6, series: "coarse", stressArea: 6.78, d0: 2.938,
    loads: {
  ...
  {
    designation: "M4x0.7", size: "M4", diameter: 4, pitch: 0.7, series: "coarse", stressArea: 8.78, d0: 3.344,
    loads: {
  ...
  {
    designation: "M5x0.8", size: "M5", diameter: 5, pitch: 0.8, series: "coarse", stressArea: 14.2, d0: 4.252,
    loads: {
  ...
  {
    designation: "M6x1", size: "M6", diameter: 6, pitch: 1, series: "coarse", stressArea: 20.1, d0: 5.059,
    loads: {
  ...
  {
    designation: "M7x1", size: "M7", diameter: 7, pitch: 1, series: "coarse", stressArea: 28.9, d0: 6.066,
    loads: {
  ...
  {
    designation: "M8x1.25", size: "M8", diameter: 8, pitch: 1.25, series: "coarse", stressArea: 36.6, d0: 6.826,
    loads: {
  ...
  {
    designation: "M8x1", size: "M8", diameter: 8, pitch: 1, series: "fine", stressArea: 39.2, d0: 7.065,
    loads: {
  ...
  {
    designation: "M10x1.5", size: "M10", diameter: 10, pitch: 1.5, series: "coarse", stressArea: 58, d0: 8.593,
    loads: {
  ...
  {
    designation: "M10x1.25", size: "M10", diameter: 10, pitch: 1.25, series: "fine", stressArea: 61.2, d0: 8.827,
    loads: {
  ...
  {
    designation: "M10x1", size: "M10", diameter: 10, pitch: 1, series: "fine", stressArea: 64.5, d0: 9.062,
    loads: {
  ...
  {
    designation: "M12x1.75", size: "M12", diameter: 12, pitch: 1.75, series: "coarse", stressArea: 84.3, d0: 10.36,
    loads: {
  ...
  {
    designation: "M12x1.5", size: "M12", diameter: 12, pitch: 1.5, series: "fine", stressArea: 88.1, d0: 10.591,
    loads: {
  ...
  {
    designation: "M12x1.25", size: "M12", diameter: 12, pitch: 1.25, series: "fine", stressArea: 92.1, d0: 10.829,
    loads: {
  ...
  {
    designation: "M14x2", size: "M14", diameter: 14, pitch: 2, series: "coarse", stressArea: 115, d0: 12.101,
    loads: {
  ...
  {
    designation: "M14x1.5", size: "M14", diameter: 14, pitch: 1.5, series: "fine", stressArea: 125, d0: 12.616,
    loads: {
  ...
  {
    designation: "M16x2", size: "M16", diameter: 16, pitch: 2, series: "coarse", stressArea: 157, d0: 14.139,
    loads: {
  ...
  {
    designation: "M16x1.5", size: "M16", diameter: 16, pitch: 1.5, series: "fine", stressArea: 167, d0: 14.582,
    loads: {
  ...
  {
    designation: "M18x2.5", size: "M18", diameter: 18, pitch: 2.5, series: "coarse", stressArea: 192, d0: 15.635,
    loads: {
  ...
  {
    designation: "M18x1.5", size: "M18", diameter: 18, pitch: 1.5, series: "fine", stressArea: 216, d0: 16.584,
    loads: {
  ...
  {
    designation: "M20x2.5", size: "M20", diameter: 20, pitch: 2.5, series: "coarse", stressArea: 245, d0: 17.662,
    loads: {
  ...
  {
    designation: "M20x1.5", size: "M20", diameter: 20, pitch: 1.5, series: "fine", stressArea: 272, d0: 18.61,
    loads: {
  ...
  {
    designation: "M22x2.5", size: "M22", diameter: 22, pitch: 2.5, series: "coarse", stressArea: 303, d0: 19.642,
    loads: {
  ...
  {
    designation: "M22x1.5", size: "M22", diameter: 22, pitch: 1.5, series: "fine", stressArea: 333, d0: 20.591,
    loads: {
  ...
  {
    designation: "M24x3", size: "M24", diameter: 24, pitch: 3, series: "coarse", stressArea: 353, d0: 21.2,
    loads: {
  ...
  {
    designation: "M24x2", size: "M24", diameter: 24, pitch: 2, series: "fine", stressArea: 384, d0: 22.112,
    loads: {
  ...
  {
    designation: "M27x3", size: "M27", diameter: 27, pitch: 3, series: "coarse", stressArea: 459, d0: 24.175,
    loads: {
  ...
  {
    designation: "M27x2", size: "M27", diameter: 27, pitch: 2, series: "fine", stressArea: 496, d0: 25.13,
    loads: {
  ...
  {
    designation: "M30x3.5", size: "M30", diameter: 30, pitch: 3.5, series: "coarse", stressArea: 561, d0: 26.726,
    loads: {
  ...
  {
    designation: "M30x2", size: "M30", diameter: 30, pitch: 2, series: "fine", stressArea: 621, d0: 28.119,
    loads: {
  ...
  {
    designation: "M33x3.5", size: "M33", diameter: 33, pitch: 3.5, series: "coarse", stressArea: 694, d0: 29.726,
    loads: {
  ...
  {
    designation: "M33x2", size: "M33", diameter: 33, pitch: 2, series: "fine", stressArea: 761, d0: 31.128,
    loads: {
  ...
  {
    designation: "M36x4", size: "M36", diameter: 36, pitch: 4, series: "coarse", stressArea: 817, d0: 32.253,
    loads: {
  ...
  {
    designation: "M36x3", size: "M36", diameter: 36, pitch: 3, series: "fine", stressArea: 865, d0: 33.187,
    loads: {
  ...
  {
    designation: "M39x4", size: "M39", diameter: 39, pitch: 4, series: "coarse", stressArea: 976, d0: 35.252,
    loads: {
  ...
  {
    designation: "M39x3", size: "M39", diameter: 39, pitch: 3, series: "fine", stressArea: 1030, d0: 36.214,
    loads: {
